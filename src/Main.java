...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Yesterday " + person1 + " and " + person2 + " were selling " + drink + " for " + score3
				+ " dollars at " + location + " . " + "After selling " + drink + " at " + location + " for " + decNumber
				+ " minutes, a " + animal + "" + " attacked them and stole " + score4 + " dollars from them . " + ""
				+ person1 + " and " + person2 + " started " + emotion
				+ " until a good samaritan saw what happend and decided " + "to give them " + score2 + " dollars");
